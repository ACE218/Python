#Write a program in python to input the lower and upper limit and print all the prime number lles between the ranges. Also print the following information.
#a. Count number of prime numbers. b. Count number of 2-digit prime number.
def is_prime(num):
    if num < 2:
        return False
